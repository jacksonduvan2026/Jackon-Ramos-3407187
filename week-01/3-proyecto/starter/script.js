...
console.log('=========================================');
console.log('[VENTA DE ROPA INFANTIL - 3407187');
console.log('=========================================');
console.log('');
...
console.log('Categoría:      Saco de lana');
...
console.log('Valor principal:   1500000');
...
console.log('Valor calculado:    ', 1500000 * 0.11); // TODO: reemplaza 0 con tu cálculo
...
console.log('Dominio:   VENTA DE ROPA INFANTIL');
...
console.log('Total registros:  15');
...
console.log('moda y estilo para los mas pewueños');
